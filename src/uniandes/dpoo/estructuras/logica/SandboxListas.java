...
public class SandboxListas
{
    ...
    {
        int calCulo = listaEnteros.size();
        List<Integer> copia = new ArrayList<Integer>(calCulo);
    ...
    {
        List<Integer> remplazo = new ArrayList<Integer>();
        for (int i = 0; i < valores.length; i++)
        {
            remplazo.add((int) valores[i]);
        }
        listaEnteros = remplazo;
    }
    ...
    {
        List<String> remplazo = new LinkedList<String>();
        for (int i = 0; i < objetos.size(); i++)
        {
            remplazo.add(String.valueOf(objetos.get(i)));
        }
        listaCadenas = remplazo;
    }
    ...
    public void organizarEnteros( )
    {
        ...
        for (int i = 0; i < calCulo - 1; i++)
        {
            ...
            {
                if (listaEnteros.get(j) > listaEnteros.get(maxi))
                {
                    maxi = j;
                }
            }
            int temp = listaEnteros.get(i);
            listaEnteros.set(i, listaEnteros.get(maxi));
            listaEnteros.set(maxi, temp);
        }
    }
    ...
    public void organizarCadenas( )
    {
        ...
        for (int i = 0; i < calCulo - 1; i++)
        {
            ...
            for (int j = i + 1; j < calCulo; j++)
            {
                if (listaCadenas.get(j).compareTo(listaCadenas.get(mini)) < 0)
                {
                    mini = j;
                }
            }
            String temp = listaCadenas.get(i);
            listaCadenas.set(i, listaCadenas.get(mini));
            listaCadenas.set(mini, temp);
        }
    }
    ...
    public int contarEnterosRepetidos( )
    {
        ...
        while (i < calCulo - 1)
        {
            int valor = listaEnteros.get(i);
            int repes = 1;
            while (i + repes < calCulo && listaEnteros.get(i + repes) == valor)
            {
                repes++;
            }
            if (repes > 1) repetidos++;
            i += repes;
        }
        return repetidos;
    }
    ...
    public void generarEnteros( int cantidad, int minimo, int maximo )
    {
        ...
        List<Integer> remplazo = new ArrayList<Integer>(cantidad);
