...
public class SandboxConjuntos
{
    ...
    {
    	{
    	    ...
    	    NavigableSet<String> vista = arbolCadenas.tailSet(cadena, true);
    	    TreeSet<String> remplazo = new TreeSet<String>();
    	    for (String s : vista)
    	    {
    	        remplazo.add(s);
    	    }
    ...
    {
        java.util.Iterator<String> it = arbolCadenas.iterator();
        while (it.hasNext())
        {
    ...
    public void reiniciarConjuntoCadenas( List<Object> objetos )
    {
        ...
        {
            String comoTexto = String.valueOf(objetos.get(i));
            arbolCadenas.add(comoTexto);
        }
    }
    ...
    {
        NavigableSet<String> remplazo = new TreeSet<String>();
        for (String s : arbolCadenas)
        {
            if (s != null)
            {
                remplazo.add(s.toUpperCase());
            }
        }

        arbolCadenas = remplazo;
    }
    ...
    public boolean compararElementos( String[] otroArreglo )
    {
        ...
        {
            String buscada = otroArreglo[i];
            if (!arbolCadenas.contains(buscada))
            {
                return false; 
            }
        }
